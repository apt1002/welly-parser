...
Whitespace and comments are removed, except in "doc string positions". If a parse error occurs, the parser does not make a parse tree. Because of these losses, this parser *is not* suitable for use in a code reformatter.
